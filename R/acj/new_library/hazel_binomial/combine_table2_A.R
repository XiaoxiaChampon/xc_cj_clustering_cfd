...
#      outputs/PaperTables/Table2Files/A_100_binomial_hazel_table2/
#      -> copy it to the standard output folder and use it directly.
#   2. If batch outputs exist in
#      outputs/clustersims/A_10_binomial_hazel_table2/batch_1..10/
...
#   outputs/clustersims/A_100_binomial_hazel_table2/
#     ClusterSim_{n}_2000_A_100_binomial_FALSE_neworder.RData
# ============================================================
...
papertables_src <- file.path(
  ...
  "outputs", "clustersims", "RAW_HAZEL_BINOMIAL",
  "A_100_binomial_hazel_table2", "batch_0"
)
batch_root <- file.path("outputs", "clustersims",
                        "A_10_binomial_hazel_table2")
