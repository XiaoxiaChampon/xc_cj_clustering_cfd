...
#
#   Scenario A:
#     n=100  : outputs/clustersims/A_100_multinomial_hazel_table2/
#                ClusterSim_100_2000_A_100_multinomial_FALSE_neworder.RData
#              (produced by combine_table2_A.R from Table2Files)
#     n=500  : same folder, n=500 variant
#     n=1000 : outputs/clustersims/A_100_multinomial_hazel_table1/
#                ClusterSim_1000_2000_A_100_multinomial_TRUE_neworder.RData
#              (produced by combine_table1_A.R after array batch jobs)
#
#   Scenario B:
#     n=100  : outputs/PaperTables/Table2Files/B_100_multinomial_hazel_table2/
#                ClusterSim_100_2000_B_100_multinomial_FALSE_neworder.RData
#     n=500  : same folder, n=500 variant
#     n=1000 : outputs/PaperTables/B_100_multinomial_hazel/
#                ClusterSim_1000_2000_B_100_multinomial_FALSE_neworder.RData
# ============================================================

proj_root <- "D:/PROJECTS/PAPERS/jasa_paper/xc_cj_clustering_cfd"

# Helper: load est_values from a file, stop if missing
...
file_A500 <- file.path(proj_root, "outputs", "clustersims",
  "A_100_multinomial_hazel_table2",
  "ClusterSim_500_2000_A_100_multinomial_FALSE_neworder.RData")

file_A1000 <- file.path(proj_root, "outputs", "clustersims",
  "A_100_multinomial_hazel_table1",
  "ClusterSim_1000_2000_A_100_multinomial_TRUE_neworder.RData")

file_B100 <- file.path(proj_root, "outputs", "PaperTables",
  "Table2Files", "B_100_multinomial_hazel_table2",
  "ClusterSim_100_2000_B_100_multinomial_FALSE_neworder.RData")

file_B500 <- file.path(proj_root, "outputs", "PaperTables",
  "Table2Files", "B_100_multinomial_hazel_table2",
  "ClusterSim_500_2000_B_100_multinomial_FALSE_neworder.RData")

file_B1000 <- file.path(proj_root, "outputs", "PaperTables",
  "B_100_multinomial_hazel",
  "ClusterSim_1000_2000_B_100_multinomial_FALSE_neworder.RData")
...
ev_B1000 <- load_ev(file_B1000)

# ---------- Extract ARI and RI (mean and SE) ----------
extract <- function(ev, metric) {
  list(
...
cells <- list(
  A_n100  = list(ARI = extract(ev_A100,  "dbscan ARI"), RI = extract(ev_A100,  "dbscan RI")),
  A_n500  = list(ARI = extract(ev_A500,  "dbscan ARI"), RI = extract(ev_A500,  "dbscan RI")),
  A_n1000 = list(ARI = extract(ev_A1000, "dbscan ARI"), RI = extract(ev_A1000, "dbscan RI")),
  B_n100  = list(ARI = extract(ev_B100,  "dbscan ARI"), RI = extract(ev_B100,  "dbscan RI")),
  B_n500  = list(ARI = extract(ev_B500,  "dbscan ARI"), RI = extract(ev_B500,  "dbscan RI")),
  B_n1000 = list(ARI = extract(ev_B1000, "dbscan ARI"), RI = extract(ev_B1000, "dbscan RI"))
)
...
out_csv <- file.path(proj_root, "outputs", "table2_raw.csv")
