...
############################################################
# Article: Functions to Perform Simulation for Clustering Categorical Functional Data using Sampling
...
fadp_cluster <- function(mZ1, mZ2, tt=tt, PVE=0.95){
  ...
  fdabasis = fda::create.bspline.basis(c(0,1), 5, 4)
  fdatime = tt
                                  ...
                                  nt2000data)
{
  ...
  for(replica_idx in 1:num_replicas)
  {
    ...
    Z1=nt2000data$Z_true_curves[[replica_idx]][tsample,nsample,1]
    Z2=nt2000data$Z_true_curves[[replica_idx]][tsample,nsample,2]
    ...
    # 
    p1 <- nt2000data$p_true_curves[[replica_idx]][tsample,nsample,1]
    p2 <- nt2000data$p_true_curves[[replica_idx]][tsample,nsample,2]
    p3 <- nt2000data$p_true_curves[[replica_idx]][tsample,nsample,3]
    ...
    categ_func_data_list_W =nt2000data$W_cfd[[replica_idx]][tsample,nsample]
  ...
  cluster_table_true=c(
                       # mean(results$true_dbscan_ri_cfda),
                       # mean(results$true_dbscan_ari_cfda),
                       # mean(results$true_dbscan_cpn_cfda),
  ...
  cluster_table_est=c( 
                       # mean(results$est_dbscan_ri_cfda),
                       # mean(results$est_dbscan_ari_cfda),
                       # mean(results$est_dbscan_cpn_cfda),
                       # 
                       mean(results$est_fadp_ri),
  ...
  cluster_table_est_se=c(
                        # sd(results$est_dbscan_ri_cfda)/sqrt(num_replicas),
                        #  sd(results$est_dbscan_ari_cfda)/sqrt(num_replicas),
                        #  sd(results$est_dbscan_cpn_cfda)/sqrt(num_replicas),
                        #  
                         sd(results$est_fadp_ri)/sqrt(num_replicas),
...
RunExperimentSub <- function(scenario, num_replicas, est_choice,n1000t2000data)
{
  # scenario="A"
  # num_replicas=2
  # est_choice="probit"
  # n1000t2000data=A_2_probit
  ...
  n100t2000C <- ClusterSimulation_Sub(100,2000,scenario,num_replicas,est_choice,TRUE,n1000t2000data)
  ...
  n500t2000C <- ClusterSimulation_Sub(500,2000,scenario,num_replicas,est_choice,TRUE,n1000t2000data)
  ...
  n1000t2000C <- ClusterSimulation_Sub(1000,2000,scenario,num_replicas,est_choice,TRUE,n1000t2000data)
  
  
  # true_tableC <- rbind(n100t300C$cluster_table_true,n100t750C$cluster_table_true,n100t2000C$true_tableC[3,],
  #                      n500t300C$cluster_table_true,n500t750C$cluster_table_true,n500t2000C$true_tableC[6,],
  #                      n1000t300C$cluster_table_true,n1000t750C$cluster_table_true,n1000t2000C$true_tableC[9,])
  # 
  true_tableC <- rbind(n100t300C$cluster_table_true,n100t750C$cluster_table_true,n100t2000C$cluster_table_true,
                       n500t300C$cluster_table_true,n500t750C$cluster_table_true,n500t2000C$cluster_table_true,
                       n1000t300C$cluster_table_true,n1000t750C$cluster_table_true,n1000t2000C$cluster_table_true)
  ...
  # est_tableC <- rbind(n100t300C$cluster_table_est,n100t750C$cluster_table_est,n100t2000C$est_tableC[3,],
  #                     n500t300C$cluster_table_est,n500t750C$cluster_table_est,n500t2000C$est_tableC[6,],
  #                     n1000t300C$cluster_table_est,n1000t750C$cluster_table_est,n1000t2000C$est_tableC[9,])
  # 
  ...
  # est_tableC_se <- rbind(n100t300C$cluster_table_est_se,n100t750C$cluster_table_est_se,n100t2000C$est_tableC_se[3,],
  #                        n500t300C$cluster_table_est_se,n500t750C$cluster_table_est_se,n500t2000C$est_tableC_se[6,],
  #                        n1000t300C$cluster_table_est_se,n1000t750C$cluster_table_est_se,n1000t2000C$est_tableC_se[9,])
  # 
  est_tableC_se <- rbind(n100t300C$cluster_table_est_se,n100t750C$cluster_table_est_se,n100t2000C$cluster_table_est_se,
                         n500t300C$cluster_table_est_se,n500t750C$cluster_table_est_se,n500t2000C$cluster_table_est_se,
                         n1000t300C$cluster_table_est_se,n1000t750C$cluster_table_est_se,n1000t2000C$cluster_table_est_se)
...
# 
# set.seed(123)
# B_2_probit_fullmse <- RunExperiment("B",2,"probit")
# save(B_2_probit_fullmse,file="B_2_probit_fullmse.RData")
