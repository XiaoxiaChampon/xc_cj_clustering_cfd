...
#   t=300 : 100 reps/batch x 1 batch  (batch_0) -> A_100_binomial_hazel_table1/
#   t=750 : 100 reps/batch x 1 batch  (batch_1) -> A_100_binomial_hazel_table1/
#   t=2000:  50 reps/batch x 2 batches (batch_1,2) -> A_50_binomial_hazel_table1/
#
...
#     ClusterSim_1000_{t}_A_100_binomial_TRUE_neworder.RData
# ============================================================
...
t_configs <- list(
  "300"  = list(num_batches = 1, reps_per_batch = 100, batch_start = 0, folder = "A_100_binomial_hazel_table1"),
  "750"  = list(num_batches = 1, reps_per_batch = 100, batch_start = 1, folder = "A_100_binomial_hazel_table1"),
  "2000" = list(num_batches = 2, reps_per_batch =  50, batch_start = 1, folder = "A_50_binomial_hazel_table1")
)

batch_root_base <- file.path("outputs", "clustersims", "RAW_HAZEL_BINOMIAL")

out_folder <- file.path("outputs", "clustersims", "A_100_binomial_hazel_table1")
...
for (tt in t_lengths) {
  ...
  for (b in seq(batch_start, batch_start + num_batches - 1)) {
