...
# sim_outputs_root points to the outputs/ folder produced by the simulation jobs.
...
proj_root        <- sim_outputs_root   # kept for compatibility with file.path() calls below
