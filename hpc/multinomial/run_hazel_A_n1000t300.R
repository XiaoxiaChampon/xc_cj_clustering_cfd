# ============================================================
# Hazel HPC -- Scenario A | n=1000, t=300
...
n1000t300 <- ClusterSimulation(
  1000, 300, scenario, num_replicas, est_choice,
...
end_time <- Sys.time()
print("run_hazel_table1_A_n1000t300.R completed")
cat("\nTotal time:\n")
print(end_time - start_time)
flush(stdout())

cat("\n=== catFDA-dbscan ARI -- Scenario A | n=1000, t=300 ===\n")
cat(sprintf("  Mean ARI : %.4f\n", n1000t300[[est_choice]]$cluster_table_est["dbscan ARI"]))
cat(sprintf("  SE (ARI) : %.4f\n", n1000t300[[est_choice]]$cluster_table_est_se["dbscan ARI"]))
